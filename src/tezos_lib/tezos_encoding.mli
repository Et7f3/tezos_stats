...
module Encoding : sig
  ...
  module Block_header : sig
    val block_shell_encoding : Tezos_types.block_shell Json_encoding.encoding
...
(* val constants_dft : Tezos_types.constants Json_encoding.encoding *)
val conn_metadata_encoding :
  Tezos_types.conn_metadata Json_encoding.encoding

module Checkpoint : sig
  val block_shell_gen_encoding : Tezos_types.block_shell_gen Json_encoding.encoding
  val checkpoint_encoding : Tezos_types.checkpoint Json_encoding.encoding
end
